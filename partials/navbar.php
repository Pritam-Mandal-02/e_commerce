        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
          ...
          <div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown">
            ...
            if ($is_authenticated && $role == 2) { ?>
              <div class="navbar-nav">
                <li class="nav-item">
                  <a class="nav-link active" aria-current="page" href="../cart/cart_list.php"><i class="fa-solid fa-cart-shopping"></i><?php if ($cart_item > 0) echo $cart_item ?></a>
                </li>
              </div>
            <?php }
            if ($is_authenticated) { ?>
